...
var stockCount = 3;
function chooseToEat(stockCount) {
    if (stockCount >= 1) {
    return `I am going to eat some ${food}!`
  } else {
    return `We need to get some more ${food}.`
  }
}

console.log(chooseToEat(stockCount));
...
function talkAboutFood(isFavorite) {
  if (isFavorite === true) {
...
console.log(talkAboutFood(isFavorite));
...
var fruits = ['Cherries', 'Raspberries', 'Bananas', 'Strawberries', 'Blackberries', 'Oranges', 'Grapes'];
console.log(fruits);
